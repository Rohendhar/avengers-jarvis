...
| :--- | :--- | :--- | :--- |
| **Mechanical & Structural** | $150.00 | $0.00 | Frame steel/alu (Welding lab), Linear rails, Lead screw, Bearings, Fasteners |
| **Fluidics & Plumbing** | $120.00 | $0.00 | 4x 12V Food-Grade Peristaltic Pumps, Silicone Tubing, Check Valves, Sanitary Fittings |
| **Thermal Cooling (Mini-Fridge)** | $140.00 | $0.00 | Compact compressor/thermoelectric mini-fridge table insert (Plan B selected) |
| **Motors & Drivers** | $70.00 | $0.00 | NEMA 17 Stepper, TMC2209 Silent Drivers, Actuators |
| **Electronics & Compute** | $110.00 | $0.00 | ESP32 / Arduino, 12V Power Supply, Buck Converters, Relays/MOSFETs, Sensors |
| **Enclosure & Presentation** | $100.00 | $0.00 | Table top materials, Acrylic viewing window, Food-safe PETG 3D filament |
| **Contingency / Spares** | $100.00 | $0.00 | Wire harnesses, connectors, spare tubing, emergency cutoff |
| **Total Estimated Initial** | **~$790.00** | **$0.00** | Prototype target ~$300–$500, **formal budget ceiling raised to $1,500.00** |
...
- **Startup Weekend Edge**: Most competitors present slide decks only. A tangible, working automated table prototype will be a dominant physical differentiator.
